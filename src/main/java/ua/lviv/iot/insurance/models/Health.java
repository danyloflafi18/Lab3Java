...
public class Health extends Insurance {
    ...
    public Health(final String name, final String surname,
            final int numberOfDays, final String telephone,
            final InsuranceType insuranceType, final boolean prematureDeath,
    ...
    public final String getHeaders() {
        return super.getHeaders() + "," + "Premature death" + ","
                + "Accident" + "," + "Invalidity";
    }

    @Override
    public final String toCSV() {
        return super.toCSV() + "," + this.isPrematureDeath() + ","
                + this.getAccident() + "," + this.getInvalidity();
    }
