...
public class Insurance {
    ...
    public final String toString() {
        return "Insurance{" + "name='" + name + '\'' + ", surname='"
                + surname + '\'' + ", numberOfDays=" + numberOfDays
                + ", telephone='" + telephone + '\'' + '}';
    }
    ...
    public String getHeaders() {
        return "Name" + "," + "Surname" + "," + "NumberOfDays"
                + "," + "Telephone" + "," + "InsuranceType";
    }

    public String toCSV() {
        return this.getName() + "," + this.getSurname() + ","
                + this.getNumberOfDays() + "," + this.getTelephone() + ","
