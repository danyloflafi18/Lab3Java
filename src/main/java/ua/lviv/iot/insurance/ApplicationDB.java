...
public class ApplicationDB {
    ...
    public CommandLineRunner demo(final PropertyRepository repository) {
        return (args) -> {
            repository.save(new Property("Oleh", "Klochnyk", 7, "0934284939",
                    InsuranceType.HEALTH, DangerLevel.LOW,
                    DangerLevel.LOW));
            repository.save(new Property("Yaroslav", "Klochnyk", 5, "0934284930",
                    InsuranceType.HEALTH, DangerLevel.LOW,
                    DangerLevel.LOW));
            repository.save(new Property("Yaroslav", "Chuchma", 21, "0934284935",
                    InsuranceType.HEALTH, DangerLevel.LOW,
                    DangerLevel.LOW));
