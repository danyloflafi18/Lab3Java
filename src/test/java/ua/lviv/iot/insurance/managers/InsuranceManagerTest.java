...
class InsuranceManagerTest {
    ...
    private List<Insurance> testList = new ArrayList<Insurance>();

    private InsuranceWriter testWriter = new InsuranceWriter();

    private File testFile = new File("lab_work_3_output_file");
    ...
    public void setUpForPersonal() {
        insuranceManager = new InsuranceManager();
        insuranceManager.addInsurance(new Personal("Oleh", "Klochnyk",
                7, "0934284939", InsuranceType.HEALTH,
                DangerLevel.LOW, DangerLevel.LOW));
        insuranceManager.addInsurance(new Personal("Yaroslav", "Klochnyk",
                5, "0934284930", InsuranceType.HEALTH,
                DangerLevel.LOW, DangerLevel.LOW));
        insuranceManager.addInsurance(new Personal("Yaroslav", "Chuchma",
                21, "0934284935", InsuranceType.HEALTH,
                DangerLevel.LOW, DangerLevel.LOW));
        insuranceManager.addInsurance(new Personal("Petro", "Klochnyk",
    ...
    public void setUpForProperty() {
        insuranceManager = new InsuranceManager();
        insuranceManager.addInsurance(new Property("Oleh", "Klochnyk",
                7, "0934284939", InsuranceType.HEALTH,
                DangerLevel.LOW, DangerLevel.LOW));
        insuranceManager.addInsurance(new Property("Yaroslav", "Klochnyk",
                5, "0934284930", InsuranceType.HEALTH,
                DangerLevel.LOW, DangerLevel.LOW));
        insuranceManager.addInsurance(new Property("Yaroslav", "Chuchma",
                21, "0934284935", InsuranceType.HEALTH,
                DangerLevel.LOW, DangerLevel.LOW));
        insuranceManager.addInsurance(new Property("Petro", "Klochnyk",
                10, "0934284938", InsuranceType.HEALTH,
                DangerLevel.LOW, DangerLevel.LOW));
    ...
    public void testWriteToFile() throws IOException {
        ...
        Assertions.assertEquals(testFile.length(), 0);
    }
}
